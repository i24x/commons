...
public class VmInfoBean {
    ...
    public String toString() {
        return "VmInfoBean{" + "loadClazzCount=" + loadClazzCount + ", hasloadClazzCount=" + hasloadClazzCount
            + ", hasUnloadClazzCount=" + hasUnloadClazzCount + ", heapMemoryUsage=" + heapMemoryUsage
            + ", nonHeapMemoryUsage=" + nonHeapMemoryUsage + ", operateName='" + operateName + '\''
            + ", processListCount=" + processListCount + ", archName='" + archName + '\'' + ", versionName='"
            + versionName + '\'' + ", vmName='" + vmName + '\'' + ", vmVersion='" + vmVersion + '\'' + ", vmVendor='"
            + vmVendor + '\'' + ", startTime=" + startTime + ", arguments=" + arguments + ", systemProperties="
            + systemProperties + '}';
    }
}