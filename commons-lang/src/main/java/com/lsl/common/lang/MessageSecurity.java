...
public class MessageSecurity {
    ...
    private static String md5(String msg) {
        try {
            ...
            e.printStackTrace();
            throw new RuntimeException("不支持MD5加密算法");
        }
    }
    ...
    private static String sha1(String msg) throws NoSuchAlgorithmException {
        try {
            ...
            e.printStackTrace();
            throw new RuntimeException("不支持SHA1加密算法");
        }
    }
    ...
    public static String encryptWithDES(String msg, String key) {
        if (key == null || key.length() < 8) {
            throw new RuntimeException("KEY长度不能小于8");
        }
        try {
            ...
            e.printStackTrace();
            throw new RuntimeException("无效KEY或生成KEY无效：" + key);
        } catch (NoSuchAlgorithmException e) {
            e.printStackTrace();
            throw new RuntimeException("无效加密算法DES");
    ...
    static String decryptWithDES(String src, String key) {
        ...
        try {
            ...
            e.printStackTrace();
            throw new RuntimeException("无效KEY或生成解密KEY无效：" + key);
        } catch (NoSuchAlgorithmException e) {
            e.printStackTrace();
            throw new RuntimeException("无效加密算法DES");
        } catch (NoSuchPaddingException | BadPaddingException | IllegalBlockSizeException e) {
    ...
    public static String sign(byte[] data, String privateKey) {
        ...
        try {
            ...
            e.printStackTrace();
            throw new RuntimeException("数字签名失败，不支持数字签名算法：" + KEY_ALGORITHM_RSA);
        } catch (InvalidKeySpecException | InvalidKeyException e) {
            e.printStackTrace();
            throw new RuntimeException("数字签名失败，无效私钥：" + privateKey);
        } catch (SignatureException e) {
            e.printStackTrace();
            throw new RuntimeException("数字签名失败");
        }
    }
    ...
    public static boolean verify(byte[] data, String publicKey, String sign) {
        ...
        try {
            ...
            throw new RuntimeException("验证数字签名失败，加密算法不支持：" + publicKey);
        } catch (InvalidKeySpecException | InvalidKeyException e) {
            throw new RuntimeException("验证数字签名失败，无效公钥：" + publicKey);
        } catch (SignatureException e) {
            throw new RuntimeException("验证数字签名失败：" + publicKey);
        }
    }
    ...
    public static byte[] decryptByPrivateKey(byte[] data, String privKey) {
        ...
        try {
            ...
            throw new RuntimeException("公钥解密算法无效：" + privKey);
        } catch (InvalidKeySpecException | InvalidKeyException e) {
            throw new RuntimeException("无效公钥KEY：" + privKey);
        } catch (NoSuchPaddingException | IllegalBlockSizeException | BadPaddingException e) {
            throw new RuntimeException("使用公钥解密失败：" + privKey);
        }
    }
    ...
    public static byte[] decryptByPublicKey(byte[] data, String pubKey) {
        ...
        try {
            ...
            throw new RuntimeException("公钥解密算法无效：" + pubKey);
        } catch (InvalidKeySpecException | InvalidKeyException e) {
            throw new RuntimeException("无效公钥KEY：" + pubKey);
        } catch (NoSuchPaddingException | IllegalBlockSizeException | BadPaddingException e) {
            throw new RuntimeException("使用公钥解密失败：" + pubKey);
        }
    }
    ...
    public static byte[] encryptByPublicKey(String data, String pubKey) {
        ...
        try {
            ...
            throw new RuntimeException("公钥加密算法无效：" + KEY_ALGORITHM_RSA);
        } catch (InvalidKeySpecException | InvalidKeyException e) {
            throw new RuntimeException("无效公钥KEY：" + pubKey);
        } catch (NoSuchPaddingException | IllegalBlockSizeException | BadPaddingException e) {
            throw new RuntimeException("使用公钥加密失败：" + pubKey);
        }
    }
    ...
    public static byte[] encryptByPrivateKey(byte[] data, String privKey) {
        ...
        try {
            ...
            throw new RuntimeException("私钥加密算法无效：" + KEY_ALGORITHM_RSA);
        } catch (InvalidKeySpecException | InvalidKeyException e) {
            throw new RuntimeException("无效私钥KEY：" + privKey);
        } catch (NoSuchPaddingException | IllegalBlockSizeException | BadPaddingException e) {
            throw new RuntimeException("使用私钥加密失败：" + privKey);
        }
    }
