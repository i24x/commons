...
public class FrameWorkRuntimeException extends RuntimeException implements BaseException {

    private String code = "00002";
    ...
    protected FrameWorkRuntimeException(String message, Throwable cause, boolean enableSuppression,
