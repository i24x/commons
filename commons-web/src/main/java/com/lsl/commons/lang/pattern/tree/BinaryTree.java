package com.lsl.commons.lang.pattern.tree;
...
public class BinaryTree {
    ...
    public void inOrderMin(Node Node) {
        if (Node != null && Node.isDelete() == false) {
            ...
            System.out.println("---中序遍历---Node：" + Node.getValue());
    ...
    public static void visit(Node p) {
        System.out.println("Node-V:" + p.getValue());
    }
    ...
    public static void main(String[] args) {
        ...
        // 查找测试
        System.out.println("找到了tree.find(10)：" + tree.find(10));
        // 删除测试
        // tree.find(40).setDelete(true);
        // System.out.println("找到了tree.find(40)："+tree.find(40));
    }
}
