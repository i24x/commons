package com.lsl.commons.lang.utils.mail;
...
public class Mail_163Util {
    public static String sendEmail(final String account, final String[] destnations, final String authPassWord,
    ...
    public static void main(String[] args) throws MessagingException {
        String result = Mail_163Util.sendEmail("cyang198906@163.com",
            new String[] {"610039525@qq.com", "2406352526@qq.com", "yangcao@boco.com.cn", "1938027689@qq.com"},
            "yc535689", "Java发送邮件测试", "163邮箱发送邮件......");
