...
public class MybatisConfig implements EnvironmentAware {
    ...
    private static String regexp = "execution (* com.lsl..*Impl.*(..))";
    ...
    public void setEnvironment(Environment environment) {
        ...
        try {
            propertyResolver.load(MybatisConfig.class.getClassLoader().getResourceAsStream("db/db.properties"));
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
    ...
    public PlatformTransactionManager
        annotationDrivenTransactionManager(@Qualifier("druidDataSourceTnms") DataSource ds) throws SQLException {
    ...
    public TransactionInterceptor transactionInterceptor(
        @Qualifier("txManager") PlatformTransactionManager transactionManager) throws SQLException {
    ...
    public AspectJExpressionPointcutAdvisor
        pointcutAdvisor(@Qualifier("txInterceptor") TransactionInterceptor txInterceptor) {
