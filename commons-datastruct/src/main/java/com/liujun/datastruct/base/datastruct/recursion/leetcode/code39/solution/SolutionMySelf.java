...
public class SolutionMySelf {
     ...
     *            当前的值
     * @param startIndex
     *            开始的索引号，小技巧，这样可以避免重复的计算。只需要从当前向后推进即可
     * @param collect
     *            当前已经记录的集合
     * @param resultList
     *            记录下已经求解的数据集
     */
    private void recurstion(int[] inputSrc, int target, int value, int startIndex, List<Integer> collect,
