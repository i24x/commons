...
public class FileCreate {
    ...
    public void writeFileNum(String filePath, int num) {
        ...
        try {
            ...
            while (index <= num) {
                ...
                String line =
                    localDateTime.toInstant(FileCreate.ZONE8).toEpochMilli() + " " + System.currentTimeMillis();
    ...
    public void writeMoreFile(int num) {
        ...
        for (int i = 0; i < num; i++) {
            int rowNUm = 100000;
            String line =
                "D:\\java\\test\\datastruct\\sort\\bigdata\\out_" + rowNUm + "_" + System.currentTimeMillis() + ".log";
    ...
    public static void main(String[] args) {
        LocalDateTime localDateTime = LocalDateTime.of(2018, 10, 29, 16, random.nextInt(59), random.nextInt(59));
