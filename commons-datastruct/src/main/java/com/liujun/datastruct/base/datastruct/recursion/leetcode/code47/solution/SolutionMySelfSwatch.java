 ...
 *
 * <p>
 * 这是我首先想到的解决办法，但是这存在问题，
 *
 * <p>
 * 问题1，数据中存在很多错误的组合,比如输入[1,2,3]首个就是[1, 1, 1]
 *
 * <p>
 * 问题2，重复排列的问题，相同的组合会被多次排列。
 *
 * <p>
 * 改进方案
 *
 * <p>
 * 思考了很久，没有想出来解决办法。google寻找答案，再来检查
 *
 * @author liujun
 * @version 0.0.1
 * @date 2019/09/20
...
public class SolutionMySelfSwatch {
    ...
    private void recustion(int[] input, int start, List<List<Integer>> result, List<Integer> currList) {
