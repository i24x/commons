...
public class BPlusTreeTest {
    ...
    public void testSearchRange() {
        ...
        Assert.assertArrayEquals(
            bpt.searchRange(3, BPlusTree.RangePolicy.EXCLUSIVE, 7, BPlusTree.RangePolicy.EXCLUSIVE).toArray(),
            new String[] {"e", "f", "g"});
        Assert.assertArrayEquals(
            bpt.searchRange(3, BPlusTree.RangePolicy.INCLUSIVE, 7, BPlusTree.RangePolicy.EXCLUSIVE).toArray(),
            new String[] {"d", "e", "f", "g"});
        Assert.assertArrayEquals(
            bpt.searchRange(3, BPlusTree.RangePolicy.EXCLUSIVE, 7, BPlusTree.RangePolicy.INCLUSIVE).toArray(),
            new String[] {"e", "f", "g", "h"});
        Assert.assertArrayEquals(
            bpt.searchRange(3, BPlusTree.RangePolicy.INCLUSIVE, 7, BPlusTree.RangePolicy.INCLUSIVE).toArray(),
