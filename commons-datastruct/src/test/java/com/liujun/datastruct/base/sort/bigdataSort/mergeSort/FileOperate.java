...
public class FileOperate {
     ...
     * @param sumNum
     *            写入总行数
     * @param fileMaxFileSize
     *            单文件最大大小
     * @param methos
     *            生成数据的方法
     * @return
     */
    public static List<String> Generate(String basePath, int sumNum, long fileMaxFileSize, Supplier<String> methos) {
        MultFileWrite write = new MultFileWrite(basePath, PREFIX, SUFIXNAME, DEF_MAXFILE_NUM, fileMaxFileSize);
